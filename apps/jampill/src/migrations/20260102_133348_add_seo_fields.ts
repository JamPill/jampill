...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_posts\`("id", "title", "slug", "published_at", "featured_image_id", "content", "updated_at", "created_at", "_status") SELECT "id", "title", "slug", "published_at", "featured_image_id", "content", "updated_at", "created_at", "_status" FROM \`posts\`;`)
